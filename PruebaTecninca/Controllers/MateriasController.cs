...
namespace PruebaTecninca.Controllers
{
    public class MateriasController : Controller
    {
        ...
        public MateriasController(Clase_Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre")] Materias materias)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre")] Materias materias)
        {
            if (id != materias.Id)
            {
                return NotFound();
        ...
        [HttpGet, ActionName("ViewMaterias")]
        public async Task<IActionResult> ViewMaterias()
        {
            var result = await _context.Set<ViewMaterias>().ToListAsync();
            return View(result);
